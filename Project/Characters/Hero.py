...
class Hero(Fighter, HeroEquipment):
    def __init__(self, gold, level, life_points, equipment_points, dodge_rate, parry_rate,
                 ...
                 name, exp_points, mana_points, total_min_damage, total_max_damage):
        Fighter.__init__(self, gold, level, life_points, equipment_points, dodge_rate, parry_rate,
                         critical_hit_rate, min_damage, max_damage)
    ...
    def update_damages(self):
        ...
        self.total_min_damage = self.max_damage + self.equipment_max_damage
